...
**C₁₀₆H₁₈₁O₄₅N₁₆S₀.₃P** (formula Redfield estesa per spirulina)
...
- Alcuni usano **citrato ferrico ammonico** al posto di FeSO₄ + EDTA
...
| NaHCO₃ | 3–5 g/L | Comune |
| NaCl | 1,0 g/L | Comune |
| Micronutrienti | 1 mL/L | Soluzione tracce separata |

**Note**: NPK 10-20-20 apporta N ammoniacale (NH₃-N 10%), P₂O₅ 20%, K₂O 20%. La N ammoniacale è assimilata ma più tossica del nitrato a concentrazioni > 30 mg/L NH₄⁺ → mantenere bassa e dosare a rate.  
...
|---|---|---|
| Urea | 300 | N più economico; tenere < 60 mg/L in vasca |
| MAP (NH₄H₂PO₄) | 50 | P + N |
| K₂SO₄ | 20 | K |
| MgSO₄ | 10 | Mg |
| FeSO₄·7H₂O | 3 | Fe; aggiungere in soluzione acida diluita |
| NaHCO₃ | ~400 | C (rifornimento carbonio) |

**N da urea**: urea idrolizza a NH₃ + CO₂ tramite ureasi batterica/algale. La spirulina assimila preferenzialmente NH₄⁺ poi NO₃⁻. Eccesso di urea causa picchi di NH₃ tossici (pH-dipendente: a pH 10 l'NH₃ libera è > 99%).
...
### 3.1 Carbonio — NaHCO₃ / Na₂CO₃ / CO₂

**Sistema carbonato-bicarbonato**:

```
CO₂(aq) + H₂O ⇌ H₂CO₃*   (pKa₁ = 6,35)
H₂CO₃* ⇌ H⁺ + HCO₃⁻      (pKa₁eff ≈ 6,3)
HCO₃⁻ ⇌ H⁺ + CO₃²⁻       (pKa₂ = 10,33)
```

A pH < 10,3: HCO₃⁻ è la specie dominante → viene convertita a CO₂ dalla carbonica anidrase  
A pH > 10,3: CO₃²⁻ domina → meno accessibile ma spirulina può assimilarla  
A pH > 10,8: inibizione della crescita

**Strategia operativa**:
- Caricare NaHCO₃ 16,8 g/L nel medium di partenza
- Tenere pH a 10,0–10,4 con aggiunta continua di NaHCO₃ (o CO₂ diluita)
- Jourdan: dosare NaHCO₃ per mantenere pH = 10,4; dosi basse portano a pH < 10,2 con iperproduzione di EPS
- **Rapporto pratico**: 0,4–0,8 kg NaHCO₃ per kg biomassa secca prodotta (equivale a 0,27–0,53 kg CO₂ fissata)
...
**Forme assimilabili** (in ordine di preferenza per spirulina): NH₄⁺ > NO₃⁻ ≈ NO₂⁻  
**Attenzione**: la spirulina è coltivata a pH 9–11 dove NH₃ libera è tossica anche a 30 mg/L.

| Fonte N | g N/mol | Pro | Contro | Bio EU |
|---|---|---|---|---|
| NaNO₃ (sintetico) | 85,0 | Standard, stabile | Costoso, non bio | ❌ |
| NaNO₃ naturale (caliche) | 85,0 | Ammesso EU bio 2023 | +30–50% costo vs. sintetico | ✅ (solo microalghe) |
| KNO₃ | 101,1 | Apporta K, nessun Na extra | — | ✅ (probabile, minerale) |
| Urea | 28,0 | Molto economico (0,3 €/kg) | Idrolisi, picchi NH₃, non bio | ❌ |
| MAP (NH₄H₂PO₄) | — | Apporta P | Rischio tossicità NH₄⁺ | ❌ |
...
→ N consumato = 0,2 × 0,12 = 0,024 g N/L/day = 0,14 g NaNO₃/L/day

---

### 3.3 Fosforo — K₂HPO₄ / KH₂PO₄ / struvite

**Chimica**: il fosfato precipita come Ca₃(PO₄)₂ o CaHPO₄ a pH > 9 in presenza di Ca²⁺. Per questo K₂HPO₄ va aggiunto **dopo** CaCl₂ (o in fase separata).

| Fonte P | g P/mol | Note | Bio EU |
|---|---|---|---|
| K₂HPO₄ | 174,2 | Standard; solubile; apporta K | ⚠️ Da verificare |
| KH₂PO₄ | 136,1 | Più acido; abbassa pH iniziale | ⚠️ Da verificare |
...
| K₂HPO₄ | Doppia funzione K+P | ⚠️ |
| KCl (cloruro potassio) | Aggiunto a Reg 2021/1165 nel 2023 | ✅ (dal 2023) |
| KNO₃ | N+K; vedi §3.2 | ✅ (probabile) |

Il Zarrouk apporta K totale: K₂HPO₄ (0,5 g/L = 2,87 mM K) + K₂SO₄ (1,0 g/L = 11,5 mM K) ≈ 14,4 mM K totale.
...
- 0,2 g/L = 0,81 mM. Cofactore di clorofilla e ATP-asi.
...
- Eccesso di Ca²⁺ porta a precipitazione di CaCO₃ e CaHPO₄ a pH > 9 → usare la dose minima.
- L'acqua di rete può già contenere Ca²⁺ sufficiente (durezza > 5°dH) → analizzare l'acqua prima di aggiungere CaCl₂.

---

### 3.6 Ferro e chelazione

**Il problema**: Fe²⁺ si ossida rapidamente a Fe³⁺ a pH > 7, che precipita come Fe(OH)₃ (Ksp = 10⁻³⁸·⁸). A pH 10 la solubilità del Fe³⁺ libero è < 10⁻⁸ M — praticamente zero senza chelante.

**EDTA come chelante standard (Zarrouk)**:
- Na₂-EDTA 0,08 g/L (0,215 mM) stabilizza FeSO₄ 0,01 g/L (0,036 mM Fe²⁺)
- Rapporto Fe:EDTA molare ≈ 1:6 (eccesso EDTA garantisce chelazione a tutti i pH)
- EDTA è non biodegradabile, bioaccumulante, **vietato in bio EU**

**Alternativa bio-compatibile — citrato ferrico**:
```
Fe³⁺ + 3 Citrate³⁻ → [Fe(Cit)₃]⁶⁻   (log K = 11,85)
```
- Citrato ferrico (C₆H₅FeO₇) o citrato ferrico ammonico (FeNH₄(C₆H₅O₇)₂)
- Solubile a pH 8–11; biodegradabile; origine vegetale → **bio-ammesso**
- Dose equivalente: 0,016–0,020 g/L Fe come citrato ferrico ≈ 0,08 g/L citrato ferrico ammonico
- Stabilità termica inferiore a EDTA; preparare in soluzione madre acida (pH 3–4) e aggiungere subito prima dell'uso
- Concentrazione ottima in test su spirulina: 2–3 mg Fe/L (come Fe-EDTA); stessa range vale per citrato ferrico

**Alternativa pratica Jourdan**: soluzione di FeSO₄ in aceto (vinagre = acido acetico ≈ pH 2,5) a ~10 g Fe/L → dosare 0,1 mL/L nel medium, sotto agitazione continua. L'aceto abbassa il pH locale, riduce Fe³⁺ a Fe²⁺ e ritarda la precipitazione.
...
**Calcolo dosa CO₂**: per abbassare pH da 10,5 a 10,2 in 200 L → ~0,5 g CO₂ (dipende dall'alcalinità totale). In pratica: iniettare lentamente e misurare.
...
| **K₂HPO₄** o **KH₂PO₄** | 0,5 | Grado tecnico/minerale | ⚠️ (verifica ente) | Fornitori tecnici |
...
| consulenzaagricola.it (2023) | Summary normativo | Modifica febbraio 2023: NaNO₃ + KCl |
...
| Nature Sci Reports (2026) | Paper | Biofortificazione ferro, chimica Fe²⁺/Fe³⁺ |
