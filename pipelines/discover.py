    ...
    try:
        if ollama_api_key:
            ...
            try:
                ...
                llm_log_call("discover", model, j.get("prompt_eval_count", 0), j.get("eval_count", 0))
            except Exception:
                pass
            ...
            try:
                ...
                llm_log_call("discover", model, usage.get("prompt_tokens", 0), usage.get("completion_tokens", 0))
            except Exception:
                pass
